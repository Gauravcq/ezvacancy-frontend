// js/app.js (Sirf Homepage ke liye)
...
function createListItem(item) {
    ...
    else if (item.examName && item.examName.toLowerCase().includes('answer key')) tag = '<span class="bg-rose-100 text-rose-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-rose-900 dark:text-rose-300">Answer Key</span>';
